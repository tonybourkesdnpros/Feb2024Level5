...
| --------- | --------------- | ------------ | --------- |
| dc1_mlag1 | Vlan4094 | 192.168.104.0 | Port-Channel1 |
...
| Ethernet6 | host1-DC1 | *access | *10 | *- | *- | 6 |
| Ethernet7 | host1-DC1 | *access | *10 | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet3 | routed | - | 192.168.103.7/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet3 | routed | - | 192.168.103.9/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC1_Ethernet3 | routed | - | 192.168.103.11/31 | default | 1500 | False | - | - |
...
| Port-Channel6 | host1-DC1_connected to host1-DC1 | switched | access | 10 | - | - | - | - | 6 | - |
...
| Vlan3009 |  VRF_A  |  192.168.104.129/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.104.129/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.104.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.168.104.128 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.104.128 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF_A | 192.168.101.2:10 | 10:10 | - | - | learned | 10 |
...
router bgp 65101
   ...
   neighbor 192.168.104.128 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.104.128 description leaf1-DC1
